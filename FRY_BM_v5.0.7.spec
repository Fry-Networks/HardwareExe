...
a = Analysis(
    ...
    pathex=[],
    binaries=[('C:\\Users\\jimbo\\Documents\\GitHub\\DevTesting\\HardwareExe\\dist\\FRY_PoC_BM_v5.0.7.exe', 'embedded'), ('C:\\Users\\jimbo\\Documents\\GitHub\\DevTesting\\HardwareExe\\nssm.exe', 'embedded')],
