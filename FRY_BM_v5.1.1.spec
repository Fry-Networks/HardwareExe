...
a = Analysis(
    ...
    pathex=[],
    binaries=[('C:\\Users\\jimbo\\Documents\\GitHub\\DevTesting\\HardwareExe\\dist\\FRY_PoC_BM_v5.1.1.exe', 'embedded'), ('C:\\Users\\jimbo\\Documents\\GitHub\\DevTesting\\HardwareExe\\nssm.exe', 'embedded')],
