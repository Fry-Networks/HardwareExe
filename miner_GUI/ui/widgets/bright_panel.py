...
class BrightPanel(QtWidgets.QGroupBox):
    ...
    def _build_ui(self) -> None:
        ...
        self._learn_more_btn.setAccessibleName("bright_button_learn_more")
        ...
        self._details_btn.setAccessibleName("bright_button_details")
...
class _BrightDetailsDialog(QtWidgets.QDialog):
    ...
    def _build_ui(self) -> None:
        ...
        self._refresh_btn.setAccessibleName("bright_button_refresh")
        self._refresh_btn.clicked.connect(self.refresh_clicked.emit)  # type: ignore[arg-type]
        btn_row.addWidget(self._refresh_btn)
        close_btn = QtWidgets.QPushButton("Close")
        close_btn.setAccessibleName("bright_button_close")
