...
class PresearchPanel(QtWidgets.QGroupBox):
    ...
    def _build_ui(self) -> None:
        ...
        self._toggle.setAccessibleName("presearch_toggle_switch")
        ...
        self._status_label.setAccessibleName("presearch_label_status")
        ...
        self._stats_label.setAccessibleName("presearch_label_stats")
        ...
        self._refresh_btn.setAccessibleName("presearch_button_refresh")
